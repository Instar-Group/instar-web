...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    ...
    _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${""}">${slots.default ? slots.default({}) : `
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    entry = "pages/__layout.svelte-71e0a44e.js";
    js = ["pages/__layout.svelte-71e0a44e.js", "chunks/index-b6926417.js"];
    css = ["assets/pages/__layout.svelte-6bbb1d58.css"];
  }
});
...
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/index.svelte.js"() {
    init_index_5f038599();
    css3 = {
      code: ".house-points.svelte-12shxey{margin-bottom:2rem;display:flex;flex-direction:column;align-items:center;justify-content:center\n}@media(min-width: 768px){.house-points.svelte-12shxey{margin-top:1.75rem;flex-direction:row\n    }}@media(min-width: 1024px){.house-points.svelte-12shxey{margin-top:2.5rem;flex-direction:row\n    }}.main.svelte-12shxey{display:flex;flex-direction:column;align-items:center;justify-content:center\n}.logo.svelte-12shxey{display:flex;--tw-scale-x:.75;--tw-scale-y:.75;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));flex-direction:row\n}@media(min-width: 768px){.logo.svelte-12shxey{--tw-scale-x:1;--tw-scale-y:1;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))\n    }}@media(min-width: 1024px){.logo.svelte-12shxey{--tw-scale-x:1;--tw-scale-y:1;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))\n    }}.logo-text.svelte-12shxey{margin-left:0.75rem;margin-right:0.75rem;display:flex;align-items:center;justify-content:center;font-size:2.25rem;line-height:2.5rem;--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity))\n}.text-container.svelte-12shxey{margin-top:2.5rem;margin-bottom:2.5rem;display:flex;flex-direction:column;align-items:center;justify-content:center\n}",
      map: null
    };
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css3);
      return `<main class="${"main svelte-12shxey"}">
	<div class="${"logo svelte-12shxey"}"><img src="${"/static/InstarLogo.svg"}" alt="${"logo"}" height="${"100"}" width="${"100"}">
		<span class="${"logo-text svelte-12shxey"}">Instar</span></div>
	
	<div class="${"house-points svelte-12shxey"}"><div class="${"challengers"}"><div class="${"mx-5"}"><div class="${"text-container svelte-12shxey"}"><span class="${""}">Challengers</span>
					<span class="${""}">Score : 0</span></div></div></div>
		<div class="${"gladiators"}"><div class="${"mx-5"}"><div class="${"text-container svelte-12shxey"}"><span class="${""}">Gladiators</span>
					<span class="${""}">Score : 0</span></div></div></div>
		<div class="${"warriors"}"><div class="${"mx-5"}"><div class="${"text-container svelte-12shxey"}"><span class="${""}">Warriors</span>
					<span class="${""}">Score : 0</span></div></div></div>
		<div class="${"knights"}"><div class="${"mx-5"}"><div class="${"text-container svelte-12shxey"}"><span class="${""}">Knights</span>
					<span class="${""}">Score : 0</span></div></div></div></div>
</main>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_index_svelte();
    index3 = 2;
    entry3 = "pages/index.svelte-955317e2.js";
    js3 = ["pages/index.svelte-955317e2.js", "chunks/index-b6926417.js"];
    css4 = ["assets/pages/index.svelte-97517e5c.css"];
  }
});
...
var manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set(["InstarLogo.png", "InstarLogo.svg", "favicon.png", "fonts/K2D-Regular.ttf"]),
  mimeTypes: { ".png": "image/png", ".svg": "image/svg+xml", ".ttf": "font/ttf" },
  _: {
    entry: { "file": "start-e305ceb3.js", "js": ["start-e305ceb3.js", "chunks/index-b6926417.js"], "css": [] },
    nodes: [
